...
public class lab1 {
    public static void main(String[] args) {
        ...
        System.out.println(integral(-Math.PI, Math.PI, 100, func[0]));
        System.out.println(integral(-Math.PI, Math.PI, 100, func[2]));
        System.out.println(integral(-Math.PI, Math.PI, 100, func[3]));
        System.out.println();
        /*
        Шестое задание
         */
